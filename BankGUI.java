...
public class BankGUI{
    ...
    private JComboBox expyears;
    private JComboBox expmonths;
    private JComboBox expdays;
    ...
    public BankGUI(){
        ...
        expyears = new JComboBox(expYear);
        expmonths = new JComboBox(expMonth);
        expdays = new JComboBox(expDay);
                        ...
                        for(BankCard card : bankCards){
                            if (card instanceof DebitCard && card.getCardId() == cardId){
                                ...
                                if (debitCard.getPinNumber() == pinNumber && withdrawalAmount <= debitCard.getBalanceAmount()){
                                    ...
                                    JOptionPane.showMessageDialog(frame, "Incorrect PIN. Please check your PIN number and try again.");
                                    return;
                                    ...
                                    JOptionPane.showMessageDialog(frame, "Withdrawal amount exceeds balance amount. Please check your withdrawal amount and try again.");
                                    return;
                                }
                            }
